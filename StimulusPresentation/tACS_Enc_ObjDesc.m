% function [enc_out,msg]=tACS_Enc_ObjDesc(thePath)
...
try
    ...
    InstStr = ['Instructions\n\n' ...
        ...
        'the start of a new event. Subsequently, you will presented with an object that will be '...
        'shown on and off for ' num2str(PresParams.totalStimDuration) ' seconds. Your task will be ' ...
        'to indicate if the objects is a LARGER or a SMALLER than a shoe box by pressing a button. \n\n'...
