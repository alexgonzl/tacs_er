...
%   'behav_v15' --> manmade vs natural encoding task short
%   'tacs_er_xdiva_e3' --> manmande vs natural for xdiva
...
exptOptions = {'behav','behav_v3','behav_v4','behav_v5','behav_v6',...
    ...
    'tacs_er_objstim','behav_v13','behav_v14','behav_v15','tacs_er_xdiva_e3'};
